var ElDataTable = (function(e, t, i) {
  'use strict'
  function n(e) {
    n.installed || ((n.installed = !0), e.component('ElDataTable', a))
  }
  ...
  var a = {
      render: function() {
        ...
        return i(
          ...
          [
            e.searchForm.length > 0
              ? i(
                  'el-form-renderer',
                  {
                    ref: 'searchForm',
                    attrs: {inline: '', content: e.searchForm}
                  },
                  [
                    e._t('search'),
                    e._v(' '),
                    i(
                      ...
                      [
                        ...
                        e._v(' '),
                        i('el-button', {on: {click: e.onResetSearch}}, [
                          e._v('重置')
                        ])
                      ],
                      1
              ...
              : e._e(),
            e._v(' '),
            e.hasNew || e.hasDelete || e.headerButtons.length > 0
              ? i(
                  'el-form',
                  [
                    i(
                        ...
                        e.hasNew
                          ? i(
                              'el-button',
                              {
                                ...
                                on: {click: e.onDefaultNew}
                              },
                              [e._v('新增')]
                            )
                          : e._e(),
                        e._v(' '),
                        e._l(e.headerButtons, function(t, n) {
                          return 'show' in t && !t.show(e.selected)
                            ? e._e()
                            : i(
                                'el-button',
                                e._b(
                                  {
                                    ...
                                    attrs: {
                                      disabled:
                                        'disabled' in t &&
                                        t.disabled(e.selected),
                                      size: 'small'
                                    },
                                    on: {
                                      click: function(i) {
                                        t.atClick(e.selected)
                                      }
                                    }
                                  },
                                  'el-button',
              ...
              e._b(
                {
                  ...
                  ref: 'table',
                  attrs: {data: e.data, 'row-style': e.showRow},
                              ...
                              fn: function(t) {
                                return [
                                  e.isTree && e.hasNew
                                    ...
                                    : e._e(),
                                  e._v(' '),
                                  e._l(e.extraButtons, function(n, a) {
                                    return 'show' in n && !n.show(t.row)
                                      ? e._e()
                                      : i(
                                          'el-button',
                                          e._b(
            ...
            e.hasDialog
              ? i(
                  'el-dialog',
                  {
                    attrs: {title: e.dialogTitle, visible: e.dialogVisible},
                    on: {
                  ...
                  [
                    i(
                      'el-form-renderer',
                      e._b(
                        {ref: 'dialogForm', attrs: {content: e.form}},
                        'el-form-renderer',
                        e.formAttrs,
                        !1
                      ),
      ...
      data: function() {
        return {
          data: [],
          query: {},
          hasSelect: this.columns.length && 'selection' == this.columns[0].type,
          size: 10,
          page: this.firstPage,
          total: 0,
          loading: !1,
      ...
      watch: {
        query: function(e, t) {
          ;(this.page = this.firstPage), this.getList()
        },
        url: function(e, t) {
          ;(this.page = this.firstPage), this.getList()
        },
        dialogVisible: function(e, t) {
          var i = this
          e ||
            ((this.isNew = !1),
            (this.isEdit = !1),
            ...
            this.form.forEach(function(e) {
              'select' === e.$type &&
                e.$el &&
                e.$el.multiple &&
                i.$refs.dialogForm.updateValue({id: e.$id, value: []})
            }))
        }
      },
      methods: {
        getList: function() {
          var e = this,
            n = this.url,
            a = Object.assign({}, this.query, this.customQuery),
            o = this.hasPagination ? this.size : this.noPaginationSize
          if (!n) return void console.warn('DataTable: url 为空, 不发送请求')
          n.indexOf('?') > -1 ? (n += '&') : (n += '?'),
            (n += 'page=' + this.page + '&size=' + o),
            (n += Object.keys(a)
              .filter(function(e) {
                return '' !== a[e] && null !== a[e] && void 0 !== a[e]
              })
              .reduce(function(e, t) {
                return (e += '&' + t + '=' + a[t])
              }, '')),
            ...
            i
              ...
              .then(function(i) {
                ...
                e.hasPagination
                  ? ((a = t(n, e.dataPath) || []),
                    (e.total = t(n, e.totalPath)))
                  : (a = t(n, e.dataPath || 'payload') || []),
                  (e.data = a),
                  e.isTree && (e.data = e.tree2Array(a, e.expandAll)),
                  (e.loading = !1),
                  e.$emit('update', a, n)
              })
              .catch(function(t) {
        ...
        handleSizeChange: function(e) {
          this.size !== e && ((this.size = e), this.getList())
        },
        handleCurrentChange: function(e) {
          this.page !== e && ((this.page = e), this.getList())
        },
        handleSelectionChange: function(e) {
          ;(this.selected = e), this.$emit('selection-change', e)
        },
        onSearch: function() {
          var e = this.$refs.searchForm.getFormValue(),
            t = this.customQuery
          this.query = Object.assign({}, e, t)
        },
        ...
        onDefaultNew: function(e) {
          if ((void 0 === e && (e = {}), this.onNew)) return this.onNew(e)
          ;(this.row = e),
            (this.isNew = !0),
            (this.isEdit = !1),
            (this.isView = !1),
        ...
        onDefaultEdit: function(e) {
          var t = this
          if (this.onEdit) return this.onEdit(e)
          ;(this.row = e),
            (this.isEdit = !0),
            (this.isNew = !1),
            (this.isView = !1),
            ...
            this.$nextTick(function() {
              t.form.forEach(function(i) {
                var n = e[i.$id]
                t.$refs.dialogForm.updateValue({id: i.$id, value: n})
              })
            })
        },
        cancel: function() {
        ...
        confirm: function() {
          ...
          this.$refs.dialogForm.validate(function(t) {
            if (!t) return !1
            if (e.isView) return void e.cancel()
            var n = Object.assign(
                {},
                e.$refs.dialogForm.getFormValue(),
                e.extraParams
              ),
              a = 'post',
              o = e.url + ''
            e.isEdit && ((a = 'put'), (o += '/' + (e.row.id || e.row._id))),
              e.isTree &&
                (e.isNew
                  ? (n[e.treeParentKey] = e.row[e.treeParentValue])
                  : e.isEdit && (n[e.treeParentKey] = e.row[e.treeParentKey])),
              (e.confirmLoading = !0),
              i[a](o, n)
                .then(function(t) {
                  e.getList(), e.showMessage(!0), e.cancel()
                })
                .catch(function(t) {
                  e.confirmLoading = !1
                })
        ...
        onDefaultDelete: function(e) {
          var t = this
          if (this.onDelete) return this.onDelete(e)
          this.$confirm('确认删除吗', '提示', {
            type: 'warning',
            beforeClose: function(n, a, o) {
              'confirm' == n
        ...
        tree2Array: function(e, t, i, n) {
          var a = this
          void 0 === i && (i = null), void 0 === n && (n = null)
          var o = []
          return (
            e.forEach(function(e) {
              void 0 === e._expanded && a.$set(e, '_expanded', t)
              var l = 0
              if (
                (void 0 !== n && null !== n && (l = n + 1),
                a.$set(e, '_level', l),
                i && a.$set(e, 'parent', i),
                o.push(e),
                e[a.treeChildKey] && e[a.treeChildKey].length > 0)
              ) {
                var s = a.tree2Array(e.children, t, e, l)
                o = o.concat(s)
              }
            }),
            o
