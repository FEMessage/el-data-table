;(function(global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ? factory(exports, require('lodash.get'), require('axios'))
    : typeof define === 'function' && define.amd
      ? define(['exports', 'lodash.get', 'axios'], factory)
      : factory((global.ElDataTable = {}), global._get, global.axios)
})(this, function(exports, _get, axios) {
  'use strict'
    ...
    methods: {
      getList: function getList() {
        ...
        var params = Object.keys(query)
          .filter(function(k) {
            return (
              query[k] !== '' && query[k] !== null && query[k] !== undefined
            )
          })
